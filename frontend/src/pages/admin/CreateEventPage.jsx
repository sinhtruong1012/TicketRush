...
export default function CreateEventPage() {
  ...
  const [newSection, setNewSection] = useState({ name: '', rowsCount: 5, seatsPerRow: 10, price: 500000, colorCode: '#00D4FF' });
      ...
      {!eventId ? (
        <div className="admin-form card">
          <form onSubmit={handleCreateEvent}>
            <div className="form-group"><label className="form-label">Tên sự kiện *</label><input className="form-input" value={form.title} onChange={update('title')} required /></div>
            ...
            <div className="form-row">
              ...
              <div className="form-group"><label className="form-label">Ngày sự kiện *</label><input type="datetime-local" className="form-input" value={form.eventDate} onChange={update('eventDate')} required /></div>
            </div>
            <div className="form-group"><label className="form-label">Địa điểm *</label><input className="form-input" value={form.venueName} onChange={update('venueName')} required /></div>
            <div className="form-group"><label className="form-label">Địa chỉ</label><input className="form-input" value={form.venueAddress} onChange={update('venueAddress')} /></div>
        ...
        <div className="admin-form card">
          ...
          <div className="form-row">
            <div className="form-group"><label className="form-label">Tên khu vực</label><input className="form-input" value={newSection.name} onChange={updateSection('name')} placeholder="VIP-A" /></div>
          ...
          <div className="form-row">
            ...
            <div className="form-group"><label className="form-label">Giá (VND)</label><input type="number" className="form-input" value={newSection.price} onChange={updateSection('price')} min={0} /></div>
          </div>
          {renderSeatPreview()}
